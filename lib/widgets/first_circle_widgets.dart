...
class FirstCircleWidgets extends StatefulWidget {
  const FirstCircleWidgets({Key? key}) : super(key: key);

  @override
  State<FirstCircleWidgets> createState() => _FirstCircleWidgetsState();
}

class _FirstCircleWidgetsState extends State<FirstCircleWidgets> {
        ...
        (index, child) {
          _circleWidgets.add(
            TweenBuilderWidget(
              ...
              totalElementsLength:
                  _planetWidgetModel.firstCircleWidgets?.length ?? 0,
              animationDuration:
